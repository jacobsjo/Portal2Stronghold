...
public class ChunkCoordIntPair
{
     ...
     */
    public Vec3i getBlock(int x, int y, int z)
    {
        return new Vec3i((this.chunkXPos << 4) + x, y, (this.chunkZPos << 4) + z);
    }
     ...
     */
    public Vec3i getCenterBlock(int y)
    {
        return new Vec3i(this.getCenterXPos(), y, this.getCenterZPosition());
    }
